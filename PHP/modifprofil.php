<?php
/*
Ce script PHP gère la mise à jour du profil utilisateur à partir des données fournies via une requête POST.
Il vérifie d'abord si un utilisateur est connecté en vérifiant la session.
Ensuite, il récupère les données du profil, les met à jour avec les nouvelles données et les stocke dans un fichier CSV.
Le script traite également le téléchargement de la photo de profil, la supprimant si une nouvelle est téléchargée.
*/
